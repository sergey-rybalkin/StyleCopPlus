...
namespace AnalyzerPlayground
{
    public class FluentApi
    {
        ...
        {
            FluentApi.Current.Method1(string.Empty, string.Empty).Method2(string.Empty, string.Empty).Current.Method3(string.Empty, string.Empty).Method4(string.Empty, string.Empty);
        }
    }
}