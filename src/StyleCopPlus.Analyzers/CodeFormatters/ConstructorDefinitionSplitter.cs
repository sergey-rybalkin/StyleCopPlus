...
namespace StyleCopPlus.Analyzers.CodeFormatters
{
    ...
    /// </summary>
    internal class ConstructorDefinitionSplitter : CodeFormatterBase, ILongLineSplitter
    {
        ...
        public void SplitCodeLine()
        {
            ...
            SyntaxNode updatedNode = SplitArgumentsList(_node, _node.GetLeadingTrivia());
